...
import { Container, Dropdown, DropdownButton, CardGroup, Card, Col, Row, Button, Form } from "react-bootstrap";
import "./Category.css"
  ...
  return (
    <div>
        <Container style={{marginTop: "2rem", paddingLeft: 0, paddingRight: 0}}>
            <Col>
                <Row>
                    <Col><h3>Search Results</h3></Col>
                    <Col lg={7}><p>We found 37 listings</p></Col>
